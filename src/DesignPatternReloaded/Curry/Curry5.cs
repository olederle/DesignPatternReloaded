...
// .NET implementation of: https://github.com/forax/design-pattern-reloaded/blob/master/src/main/java/curry/curry5.java
...
namespace DesignPatternReloaded.Curry
{
    ...
    public static class Curry5
    {
        ...
        public static Func<string, Func<string, IVehicle>> CreateVehicleFactoryMethod()
        {
            ...
            return kind => vehicleFactoryFactory(kind).Compose(colorFactory);
        }
