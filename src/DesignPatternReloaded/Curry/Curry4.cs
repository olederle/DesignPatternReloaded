...
// .NET implementation of: https://github.com/forax/design-pattern-reloaded/blob/master/src/main/java/curry/curry4.java
...
// * Instead of the default method Function.compose we have to use an extension method for this
//   purpose.
...
namespace DesignPatternReloaded.Curry
{
    ...
    public static class Curry4
    {
        ...
        public static Func<string, Func<string, IVehicle>> CreateVehicleFactoryMethod()
        {
            ...
            return kind => colorName => vehicleFactoryFactory(kind).Compose(colorFactory)(colorName);
        }

        public static void Main(string[] args)
        {
            Func<string, Func<string, IVehicle>> createVehicle = CreateVehicleFactoryMethod();
