using System;
using Xunit;
using static DesignPatternReloaded.Monad.Monad3;

namespace DesignPatternReloadedTest.Monad
{

    public class Monad3Test
    {

        [Fact]
        public void Test_Monad3_User_WithNullName()
        {
        ...
        [Fact]
        public void Test_Monad3_User_WithEmptyName()
        {
        ...
        [Fact]
        public void Test_Monad3_User_WithAgeToSmall()
        {
        ...
        [Fact]
        public void Test_Monad3_User_WithAgeToBig()
        {
        ...
        [Fact]
        public void Test_Monad3_User_Valid()
        {
